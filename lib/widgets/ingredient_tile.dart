...
class AppColors {
  // Primary colors
  static const Color primarySaffron = Color(0xFF4CAF50);        // Mint Green primary
  static const Color primaryMintGreen = Color(0xFF66BB6A);      // Mint Green accent
  static const Color primary = primarySaffron;

  // Secondary colors
  static const Color secondarySaffronLight = Color(0xFFC8E6C9); // Light mint green
  static const Color secondaryMintLight = Color(0xFFB2DFDB);    // Soft teal (kept)

  // Background colors
  static const Color backgroundLight = Color(0xFF243923);       // Dark green background
  static const Color backgroundDark = Color(0xFF19271A);        // Very dark green background

  // Text colors
  static const Color textLight = Color(0xFFF1F8E9);             // Very light greenish white
  static const Color textDark = Color(0xFF1B5E20);              // Dark green text
  static const Color darkText = Color(0xFF1B5E20);              // Alias for dark text
  static const Color textSubtitle = Color(0xFFA5D6A7);          // Light greenish gray
  ...
  static const Color warning = Color(0xFFFFB74D);               // Orange-yellow warning
  static const Color info = Color(0xFF4DB6AC);                  // Teal info accent
}
